...
using PokermetrixWP7.Chart;
using PokermetrixWP7.Util;
...
namespace PokermetrixWP7
{
    public partial class PreflopProfitabilityControl : UserControl
    {
        ...
        private void Refresh()
        {
            ...
            string txtProfitLoss = expectedValue < 0 ? "Loss" : "Profit";
            lblProfitability.Text = string.Format("Expected {0} Big Blinds {1}", expectedValue.ToString(), txtProfitLoss);
            //bulletGraph.FeaturedMeasure = expectedValue < 0.5 ? expectedValue : 0.5;
            //bulletGraph.Data = ChartTestData(expectedValue);
            ...
            gridResult.Visibility = valueVisibility;
            ...
            lblStrength.Foreground = expectedValue > 0 ? (Brush)Application.Current.Resources["GreenBrush"] : expectedValue < 0 ? (Brush)Application.Current.Resources["RedBrush"] : (Brush)Application.Current.Resources["BlackBrush"];
        ...
        //public static List<ChartSeriesData> ChartTestData(double expectedValue)
        //{
        //    List<ChartSeriesData> list = new List<ChartSeriesData>();
        //    List<string> names = new List<string>() { "Series A" };//, "Series B", "Series C", "Series D", "Series E", "Series F" };
        //    Random rnd = new Random();
        //    for (int i = 0; i < 1; i++)
        //    {
        //        ChartSeriesData data = new ChartSeriesData();
        //        data.DataMainMin = -0.5;
        //        data.DataMainMax = -0.1;
        //        data.DataAlternateMin = -0.5;
        //        data.DataAlternateMax = 0.5;
        //        data.SeriesName = string.Empty;
        //        data.MainBrush = expectedValue > 0 ? (Brush)Application.Current.Resources["GreenBrush"] : expectedValue < 0 ? (Brush)Application.Current.Resources["RedBrush"] : (Brush)Application.Current.Resources["BlackBrush"];
        //        data.AlternateBrush = new SolidColorBrush(Color.FromArgb(0,0,0,0));
        //        list.Add(data);
        //    }
        //    return list;
        //}
